...
var BundledModelPrices = []ModelPrice{
	...
	{"gemini-3-1-pro", 1.50, 10.00, "google", "Antigravity default; 2M context, agent OS"},
	{"gemini-3-5-flash", 0.40, 3.00, "google", "fastest Antigravity tier; multimodal"},
	{"gemini-3-flash", 0.30, 2.50, "google", "older flash; cheap review"},
...
var BundledRecommendations = []Recommendation{
	...
	{TaskCheapReview, "gemini-3-flash", EffortLow, "lint-style PR review; Gemini Flash is cheapest per output token. Low effort = no reasoning overhead."},
