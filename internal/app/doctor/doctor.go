...
func DefaultProbes() []ProbeSpec {
	return []ProbeSpec{
		...
		{Binary: "rg", Label: "ripgrep", VersionArgs: []string{"--version"}, Required: false, Category: "tool"},
		...
		{Binary: "go", Label: "Go", VersionArgs: []string{"version"}, Required: false, Category: "tool"},
		...
		{Binary: "gopls", Label: "gopls", VersionArgs: []string{"version"}, Required: false, Category: "lsp"},
		{Binary: "ruby-lsp", Label: "ruby-lsp", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},
		{Binary: "solargraph", Label: "solargraph", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},
		{Binary: "pyright-langserver", Label: "pyright", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},
		{Binary: "basedpyright-langserver", Label: "basedpyright", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},
		{Binary: "rust-analyzer", Label: "rust-analyzer", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},
		{Binary: "typescript-language-server", Label: "tsserver", VersionArgs: []string{"--version"}, Required: false, Category: "lsp"},

		// Supply-chain + quality tooling.
		{Binary: "golangci-lint", Label: "golangci-lint", VersionArgs: []string{"version"}, Required: false, Category: "quality"},
		{Binary: "govulncheck", Label: "govulncheck", VersionArgs: []string{"-version"}, Required: false, Category: "quality"},
		{Binary: "go-licenses", Label: "go-licenses", VersionArgs: []string{"--help"}, Required: false, Category: "quality"},
		{Binary: "gitleaks", Label: "gitleaks", VersionArgs: []string{"version"}, Required: false, Category: "quality"},
		{Binary: "syft", Label: "syft", VersionArgs: []string{"version"}, Required: false, Category: "quality"},

		// Coding-agent CLIs.
		{Binary: "claude", Label: "Claude Code", VersionArgs: []string{"--version"}, Required: false, Category: "agent"},
		{Binary: "codex", Label: "Codex", VersionArgs: []string{"--version"}, Required: false, Category: "agent"},
		{Binary: "gemini", Label: "Gemini", VersionArgs: []string{"--version"}, Required: false, Category: "agent"},
		{Binary: "kimi", Label: "Kimi", VersionArgs: []string{"--version"}, Required: false, Category: "agent"},
	}
}
...
func Run(ctx context.Context, probe *execprobe.Probe, specs []ProbeSpec, project ProjectInfo, perTimeout time.Duration) Report {
	...
	for i, s := range specs {
		...
		go func(i int, s ProbeSpec) {
			defer wg.Done()
			entries[i] = Entry{Spec: s, Result: probe.Run(ctx, s.Binary, s.VersionArgs, perTimeout)}
		}(i, s)
	}
	wg.Wait()
