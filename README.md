...
Full end-to-end walk-through: [docs/TUTORIAL.md](docs/TUTORIAL.md).
...
| [docs/TUTORIAL.md](docs/TUTORIAL.md) | Canonical end-to-end tutorial: onboarding → spec → drive → multi-agent → analytics → ship |
